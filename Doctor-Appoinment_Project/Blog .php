...
include './common/header-top.php';
 ...
 ?>
    ...
    <section
        class="relative bg-[url('../src/images/bloghead.png')] bg-cover bg-center w-[1366px] h-[250px] flex items-center  mx-auto">
        ...
        <div class="w-[658px] flex flex-col gap-8">
            ...
            <div class="w-[658px] h-[664px] flex flex-col gap-2">
                ...
                <div class="content -mt-1">
                    <h2 class="text-[#1F2B6C] font-yeseva text-[32px] font-normal leading-normal">A passion for putting
                        patients first</h2>
                    <p class="pt-2 text-[#212124] font-worksans text-base font-normal leading-[140%]">Lorem ipsum dolor
                        sit amet, consectetur adipiscing elit. Quisque placerat scelerisque tortor ornare ornare.
                        Quisque placerat scelerisque tortor ornare ornare Convallis felis vitae tortor augue. Velit
            ...
            <div class="flex justify-between items-center -mt-0.5">
                <!-- preview button -->
                <button
                    class="preview-button flex items-center gap-2 text-[#159EEC] font-worksans text-base font-normal leading-[140%]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                        <path d="M5.6153 11L0.999919 6M0.999919 6L5.6153 1M0.999919 6H11.8333" stroke="#1F2B6C"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <!-- next button -->
                <button
                    class="next-button flex items-center gap-2 text-[#159EEC] font-worksans text-base font-normal leading-[140%]">
                    <span>Next Page</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
