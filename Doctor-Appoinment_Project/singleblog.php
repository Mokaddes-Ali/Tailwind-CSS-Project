...
include './common/header-top.php';
 ...
 ?>
    ...
    <section
        class="relative bg-[url('../src/images/singlebloghead.png')] bg-cover bg-center w-[1366px] h-[250px] flex items-center  mx-auto">
        ...
        <!-- Content -->
        <div class="relative  flex flex-col gap-0 px-[187px] pt-[85px] pb-[80px] text-start text-[#1F2B6C]">
            <p
                class="text-[#1F2B6C] font-worksans text-[18px] not-italic font-normal leading-[140%] flex items-center gap-0">
                <!-- Home link -->
                ...
                <!-- Current page -->
                <span>
                    <a href="../services/services.php">Health Care</a>
                </span>
            </p>

            <h2 class="text-[#1F2B6C] -mt-3.5 font-yeseva text-[48px] not-italic font-normal leading-normal">A passion for putting patients first.
            </h2>
                ...
                <div class="flex items-center gap-6 -mt-2">
                    <div class="flex  items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="none">
                            ...
                            <path d="M12.5557 1V4.55556" stroke="#1F2B6C" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M5.44434 1V4.55556" stroke="#1F2B6C" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M1 8.11108H17" stroke="#1F2B6C" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        <p class="text-black font-worksans text-base font-normal leading-[140%]">Monday 05, September
                            2021</p>
                    </div>
                    <!-- author -->
                    <div class="flex items-center gap-1">
                        ...
                        <p class="text-black font-worksans text-base font-normal leading-[140%]">By <span>Author</span>
                        </p>
                    </div>
                    <!-- see number -->
                    <div class="see flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" viewBox="0 0 18 13" fill="none">
                            <path
                                ...
                                stroke="#526AE9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path
    ...
    <!-- Blo single card Section -->
    <section class="w-[1366px] flex gap-5 px-[187px] pt-[65px] pb-[68px]">
        <!-- left blog card -->
        <div class="w-[658px] flex flex-col gap-8">
            <!-- single blog 1 -->
            <div class="w-[658px] flex flex-col gap-2">
                <!-- blog image -->
                ...
                <div class="content -mt-1">
                    ...
                    <p class="pt-7 text-[#212124] font-worksans text-[18px] font-normal leading-[140%]">
                ...
                <div class="button pt-12 flex justify-between items-center">

                 <button
                        class="inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-[50px] bg-[#BFD2F8] text-[#1F2B6C] font-worksans text-base font-medium leading-normal">
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
                        <path d="M5.61555 11.5L1.00016 6.5M1.00016 6.5L5.61555 1.5M1.00016 6.5H11.8335" stroke="#1F2B6C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                       </svg>
                        Previous Article
                    </button>
                    ...
                    <button
                        ...
                        Next Article
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
                            <path d="M7.21795 11.5L11.8333 6.5M11.8333 6.5L7.21795 1.5M11.8333 6.5H1" stroke="#1F2B6C"
